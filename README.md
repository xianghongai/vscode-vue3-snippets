...
理解本扩展的设计之后 (Vue API 部分缩写，以及减少冲突需要特别的处理方式)，无需刻意去死记硬背，几乎没有记忆成本，释放你的小宇宙！ ヾ(´︶`*)ﾉ♬ (Vue3 很多 Composition API 更接近语言了，不像 Options API 那样模式化)
...
|----------------------------------------------------------|
| ![](./art//assets/sfc-composition-api-script-setup.png)  |
...
|------------------------------------------------|-----------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `vue-script`, Composition API `<script setup>` |                       | <small><em>\<script setup\><br>import { ref } from 'vue';<br><br>const feature = ref();<br>\</script\></em></small>                                                                                                                                                                                                                                                                                                            |
| `vue-script`, Composition API                  |                       | <small><em>\<script\><br>import { ref } from 'vue';<br><br>export default {<br>&nbsp;&nbsp;setup() {<br>&nbsp;&nbsp;&nbsp;&nbsp;const feature = ref();<br><br>&nbsp;&nbsp;&nbsp;&nbsp;return {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>&nbsp;&nbsp;&nbsp;&nbsp;};<br>&nbsp;&nbsp;},<br>};<br>\</script\></em></small>                                                                                                       |
| `vue-script`, Options API                      |                       | <small><em>\<script\><br>export default {<br>&nbsp;&nbsp;name: 'TestIndex',<br><br>&nbsp;&nbsp;data() {<br>&nbsp;&nbsp;&nbsp;&nbsp;return {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>&nbsp;&nbsp;&nbsp;&nbsp;};<br>&nbsp;&nbsp;},<br><br>&nbsp;&nbsp;mounted() {<br>&nbsp;&nbsp;&nbsp;&nbsp;<br>&nbsp;&nbsp;},<br><br>&nbsp;&nbsp;methods: {<br>&nbsp;&nbsp;&nbsp;&nbsp;<br>&nbsp;&nbsp;},<br>};<br>\</script\></em></small> |
...
| Prefix                         | VS Code Suggest Match | Snippet                                                                                                                                                                                                        |
|--------------------------------|-----------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `onBeforeMount`, `obm`         | `onbm`                | <small><em><strong><u style="color: red;">onB</u></strong>efore<strong><u style="color: red;">M</u></strong>ount(() => {<br>&nbsp;&nbsp;<br>});</em></small>                                                   |
| `onMounted`, `om`              | `onm`                 | <small><em><strong><u style="color: red;">onM</u></strong>ounted(() => {<br>&nbsp;&nbsp;<br>});</em></small>                                                                                                   |
...
| `onUpdated`, `ou`              | `onup`                | <small><em><strong><u style="color: red;">onUp</u></strong>dated(() => {<br>&nbsp;&nbsp;<br>});</em></small>                                                                                                   |
| `onBeforeUnmount`, `obum`      | `onbu`                | <small><em><strong><u style="color: red;">onB</u></strong>efore<strong><u style="color: red;">U</u></strong>nmount(() => {<br>&nbsp;&nbsp;<br>});</em></small>                                                 |
| `onUnmounted`, `oum`           | `onum`                | <small><em><strong><u style="color: red;">onU</u></strong>n<strong><u style="color: red;">m</u></strong>ounted(() => {<br>&nbsp;&nbsp;<br>});</em></small>                                                     |
...
| `async-onBeforeMount`, `asobm` | `asonbm`              | <small><em><strong><u style="color: red;">onB</u></strong>efore<strong><u style="color: red;">M</u></strong>ount(<strong><u style="color: red;">as</u></strong>ync () => {<br>&nbsp;&nbsp;<br>});</em></small> |
| `async-onMounted`, `asom`      | `asonm`               | <small><em><strong><u style="color: red;">onM</u></strong>ounted(<strong><u style="color: red;">as</u></strong>ync () => {<br>&nbsp;&nbsp;<br>});</em></small>                                                 |

The prefix screenshot (Lifecycle Hooks) / 前缀截图:

![](./art/assets/lifecycle-hooks-composition-api)
...
| `slot-named-props` | `snp`                 | <small><em>\<slot name="default" :prop="var"\>\</slot\></em></small>                                                                                                 |
| ...                |                       |                                                                                                                                                                      |
...
<em><strong><u style="color: red;">vm</u></strong></em>-<strong><u style="color: red;">r</u></strong>outer-<strong><u style="color: red;">p</u></strong>ush-<strong><u style="color: red;">n</u></strong>ame-<strong><u style="color: red;">p</u></strong>arams-<strong><u style="color: red;">q</u></strong>uery
...
<strong><u style="color: red;">r</u></strong>outer-<strong><u style="color: red;">p</u></strong>ush-<strong><u style="color: red;">n</u></strong>ame-<strong><u style="color: red;">p</u></strong>arams-<strong><u style="color: red;">q</u></strong>uery
